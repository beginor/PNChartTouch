    ...
    public partial class DemoViewController : UIViewController {
        ...
        public override void PrepareForSegue(UIStoryboardSegue segue, NSObject sender) {
            ...
            if (segue.Identifier == "CircleChart") {
                ...
                var circleChart = new PNCircleChart(new RectangleF(0, 135, 320, 200), NSNumber.FromFloat(100f), NSNumber.FromFloat(60f), false) {
                    Frame = new RectangleF(0, 135, 320, 200),
                    Total = NSNumber.FromFloat(100f),
                    Current = NSNumber.FromFloat(60f),
                    BackgroundColor = UIColor.Clear
                };
